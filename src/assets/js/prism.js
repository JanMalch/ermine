...
!(function(r) {
  ...
  ['c', { lang: 'c++', alias: 'cpp' }, 'fortran'].forEach(function(e) {
    ...
    r.languages.c &&
      (r.languages.pure['inline-lang'].inside.rest = r.util.clone(r.languages.c));
})(Prism);
...
!(function(a) {
  ...
  for (
    var e = ['function', 'function-variable', 'method', 'method-variable', 'property-access'],
      t = 0;
    t < e.length;
    t++
  ) {
...
!(function(a) {
  ...
  (a.languages.javadoc = a.languages.extend('javadoclike', {})),
    a.languages.insertBefore('javadoc', 'keyword', {
      ...
      'code-section': [
        { pattern: /(\{@code\s+)(?:[^{}]|\{[^{}]*\})+?(?=\s*\})/, lookbehind: !0, inside: e },
...
Prism.languages.t4 = Prism.languages['t4-cs'] = Prism.languages['t4-templating'].createT4(
  'csharp'
);
!(function(n) {
    ...
    var l = 'line-numbers',
      ...
      m = function(e) {
        ...
        if ('pre-wrap' === t || 'pre-line' === t) {
          ...
          s ||
            (((s = document.createElement('span')).className = 'line-numbers-sizer'),
            n.appendChild(s)),
              ...
              (l = document.createElement('span')).setAttribute('aria-hidden', 'true'),
                ...
                n.hasAttribute('data-start') &&
                  (n.style.counterReset =
                    'linenumber ' + (parseInt(n.getAttribute('data-start'), 10) - 1)),
